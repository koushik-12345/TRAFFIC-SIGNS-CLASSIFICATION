...
path = "E:\project\Traffic sign classification\myData" # folder with all the class folders
labelFile = 'E:\project\Traffic sign classification\labels\labels.csv' # file with all names of classes
batch_size_val=45  # how many to process together
